...
<div class="container bg-gray-200 w-full max-w-full h-max min-h-full px-8 py-4">
    <div class="heading flex">
        <h1 class="title flex-1 text-4xl pt-2">Pedals</h1>
        ...
        <a href="/pedals/import-csv" class="py-4 px-5 bg-blue-300 hover:bg-blue-400 duration-500">IMPORT CSV</a>
        <a href="/pedals/csv" target="_blank" class="py-4 px-5 mx-2 bg-blue-300 hover:bg-blue-400 duration-500">EXPORT CSV</a>
        <a href="/pedals/pdf" target="_blank" class="py-4 px-5 bg-green-300 hover:bg-green-400 duration-500">EXPORT PDF</a>
